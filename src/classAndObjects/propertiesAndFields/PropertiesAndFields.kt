...
/*
* Properties and fields / Propiedades y campos
* */
...
// comienza con val en lugar de var y no permite un establecedor
...
// Podemos definir accesores personalizados para una propiedad. Si definimos un getter personalizado, se llamará cada vez que accedamos a la propiedad (esto nos permite implementar una propiedad calculada).
...
// Propiedades y variables de inicialización tardía
